    ...
    computed: {
        importe: function() {
            if(this.form.data.TipoTarifa == 'm'){
                this.form.data.importe = ((this.form.data.primer * this.form.data.r_primer * this.form.data.Cubicacion) +
                ...
                this.form.data.importe = ((this.form.data.Cubicacion * this.form.data.tarifa_primer_km  * this.form.data.ruta_primer) +
