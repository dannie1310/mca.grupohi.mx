    ...
    <div id="app">
        ...
        <conciliaciones-suministro-edit inline-template v-cloak>
            ...
            <span v-if="fetching">
                ...
                <span v-else v-cloak>
            <input name="id_conciliacion" type="hidden" id="id_conciliacion"  value="{{ route('conciliaciones.suministro.show', $conciliacion) }}">
            <h1>
                CONCILIACIONES SUMINISTRO <small>(@{{ conciliacion.estado_str }})</small>
                ...
                <span v-else-if="conciliacion.estado == 2">
                    ...
                    */?>
                    ...
                    {!! Breadcrumbs::render('conciliaciones.suministro.edit', $conciliacion) !!}
                    <app-errors v-bind:form="form"></app-errors>
               <span v-if="conciliacion.estado == 0">
                   <section id="conciliar">
                       <hr>
                       <h3>CONCILIAR VIAJES</h3>
                       {!! Form::open(['route' => ['conciliaciones.suministro.detalles.store', $conciliacion->idconciliacion], 'class' => 'form_buscar', 'files' => true]) !!}
               ...
               <section id="info">
                   ...
                   <div class="row">
                       <div class="col-md-6">
                        ...
                        <div v-if="conciliacion.duplicados.length != 0" class="col-md-6">
        ...
        </conciliaciones-suministro-edit>
    </div>
